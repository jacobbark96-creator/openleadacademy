...
// .wrangler/tmp/bundle-kPpWwz/checked-fetch.js
...
// .wrangler/tmp/pages-Ta9ZBO/bundledWorker-0.11246448345816851.mjs
...
var S = /* @__PURE__ */ __name2((e, t) => () => (e && (t = e(e = 0)), t), "S");
var H = /* @__PURE__ */ __name2((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "H");
var de = /* @__PURE__ */ __name2((e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !ie.call(e, n) && n !== r && O(e, n, { get: /* @__PURE__ */ __name2(() => t[n], "get"), enumerable: !(a = se(t, n)) || a.enumerable });
  return e;
}, "de");
var V = /* @__PURE__ */ __name2((e, t, r) => (r = e != null ? re(oe(e)) : {}, de(t || !e || !e.__esModule ? O(r, "default", { value: e, enumerable: true }) : r, e)), "V");
var y;
var c = S(() => {
  y = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[fe], s = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
...
function Se() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, r) => e.has(r) ? e.get(r) : Reflect.get(globalThis, r), "get"), set: /* @__PURE__ */ __name2((t, r, a) => Ce.has(r) ? Reflect.set(globalThis, r, a) : (e.set(r, a), true), "set") });
}
__name(Se, "Se");
__name2(Se, "Se");
...
// .wrangler/tmp/pages-Ta9ZBO/2v88d4jhzr8.js
...
// .wrangler/tmp/bundle-kPpWwz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kPpWwz/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=2v88d4jhzr8.js.map
