...
var ce = /* @__PURE__ */ __name((e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !ie.call(e, n) && n !== r && H(e, n, { get: /* @__PURE__ */ __name(() => t[n], "get"), enumerable: !(a = se(t, n)) || a.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(oe(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "V");
var f;
var d = E(() => {
  f = { collectedLocales: [] };
});
...
var Ra = { async fetch(e, t, r) {
  ...
  return n.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: N }, async () => o.run({ env: t, ctx: r, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image")) return G(e, { buildOutput: x, assetsFetcher: t.ASSETS, imagesConfig: _.images });
    let i = D(e);
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.5568064921122882.mjs.map
