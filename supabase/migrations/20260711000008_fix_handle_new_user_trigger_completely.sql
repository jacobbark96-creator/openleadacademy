...
BEGIN
  ...
  ELSE
    -- Normal student/user signup (often created via Edge Function)
    ...
    VALUES (
      ...
      COALESCE((new.raw_user_meta_data->>'has_paid_signup_fee')::boolean, CASE WHEN (new.raw_user_meta_data->>'signup_fee')::numeric > 0 THEN false ELSE true END),
