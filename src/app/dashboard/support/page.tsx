  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col gap-1 -mt-2 mb-4">
        ...
        <p className="text-gray-500 text-sm">Contact our team for assistance.</p>
      </div>
      ...
      <Card className="border border-gray-100 shadow-sm bg-white rounded-2xl overflow-hidden">
        <CardContent className="p-12 text-center flex flex-col items-center justify-center text-gray-500">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">Support Portal</h3>
          <p className="text-sm max-w-sm">Please email support@openlead-academy.com for assistance.</p>
        </CardContent>
      </Card>
    </div>
  )
